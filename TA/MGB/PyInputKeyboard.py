...
#=================
    ...
    #==================
        ...
        bSuccess = True
        libAbt = os.path.abspath(inputKeyPath+ "/PyInputKB/Lib")
        self.libKeyboardPath = os.path.abspath(inputKeyPath + "/PyInputKB/KeyboardLayout/")
        #os.environ['PATH'] = os.path.normpath(libAbt) + ';' + os.environ['PATH']

        #read configuration file
        self.config = {}
        configPath =os.path.abspath(inputKeyPath + "/PyInputKB")
    ...
    #===================
        ...
        *displayIndex*: index of display which should be used (e.g. TOP or BOT) """
        ...
        OldDir = inputKeyPath + "/PyInputKB/Lib/"
        try:
